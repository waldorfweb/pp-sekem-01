(self["webpackChunkArche2"] = self["webpackChunkArche2"] || []).push([["resources_js_src_app_components_item_QuantityInput_vue"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.compInterval = (0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.defaultValue)(this.compInterval, 1);
    this.compInterval = this.compInterval === 0 ? 1 : this.compInterval;
    var minDecimals = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.floatLength)(this.min);
    var intervalDecimals = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.floatLength)(this.compInterval);
    this.compDecimals = Math.max(minDecimals, intervalDecimals);
    this.onValueChanged = (0,_helper_debounce__WEBPACK_IMPORTED_MODULE_13__.debounce)(function () {
      _this.$emit("quantity-change", _this.compValue);
    }, (0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.defaultValue)(this.timeout, 500));

    if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.variationId)) {
  ...
  computed: _objectSpread({
    ...
    isMinimum: function isMinimum() {
      return (0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isDefined)(this.compMin) && this.compValue - this.compInterval < this.compMin;
    },
    isMaximum: function isMaximum() {
      return (0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isDefined)(this.compMax) && this.compValue + this.compInterval > this.compMax;
    },
  ...
  watch: {
    basketItems: {
      handler: function handler(newValue, oldValue) {
        if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isDefined)(this.variationId)) {
          this.fetchQuantityFromBasket();
        }
      },
      deep: true
  ...
  methods: {
    increaseValue: function increaseValue() {
      var newValue = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.formatFloat)(this.compValue + this.compInterval, this.compDecimals);

      if (((0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.compMax) || newValue <= this.compMax) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    decreaseValue: function decreaseValue() {
      ...
      if (((0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.compMin) || newValue >= this.compMin) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    setValue: function setValue(value) {
      ...
      if (isNaN(value)) {
        value = (0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.defaultValue)(this.compMin, 1);
      } // limit new value to min/ max value


      value = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.limit)(value, this.compMin, this.compMax); // make sure, new value is an even multiple of interval

      var diff = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.formatFloat)((value - this.min) % this.compInterval, this.compDecimals, true);
      ...
      if (diff > 0 && diff !== this.compInterval) {
        ...
        value = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.limit)(value, this.compMin, this.compMax);
      } // cut fraction


      value = (0,_helper_number__WEBPACK_IMPORTED_MODULE_11__.formatFloat)(value, this.compDecimals);

      if (value !== this.compValue) {
        this.compValue = value;
        this.onValueChanged();
      } else if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.$refs.quantityInputField)) {
        this.$refs.quantityInputField.value = this.displayValue;
      }
    },
    fetchQuantityFromBasket: function fetchQuantityFromBasket() {
      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.min) && this.variationBasketQuantity >= this.min && this.variationBasketQuantity !== 0) {
        this.compMin = this.min % this.compInterval || this.compInterval;
      } else if (this.variationBasketQuantity === 0) {
        this.compMin = this.min;
      }

      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_12__.isNullOrUndefined)(this.max)) {
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_QuantityInput_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./QuantityInput.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/app/components/item/QuantityInput.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_QuantityInput_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 
...
//# sourceMappingURL=ceres-client-resources_js_src_app_components_item_QuantityInput_vue.js.map