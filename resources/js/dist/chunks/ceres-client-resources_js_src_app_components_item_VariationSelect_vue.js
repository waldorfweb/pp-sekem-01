(self["webpackChunkArche2"] = self["webpackChunkArche2"] || []).push([["resources_js_src_app_components_item_VariationSelect_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/app/components/item/VariationSelect.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/app/components/item/VariationSelect.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    hasSelection: function hasSelection() {
      return !(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNullOrUndefined)(this.selectedAttributes) && !Object.values(this.selectedAttributes).some(function (value) {
        return value < 0;
      });
    },
  ...
  methods: {
    ...
    getQualifiedVariations: function getQualifiedVariations(attributeId, attributeValueId, unitId) {
      if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(attributeValueId)) {
        return this.variations.filter(function (variation) {
          return (0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(variation.attributes.find(function (attribute) {
            return attribute.attributeId === attributeId && attribute.attributeValueId === attributeValueId;
          }));
        });
      } else if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(unitId)) {
        return this.variations.filter(function (variation) {
    ...
    getClosestVariations: function getClosestVariations(qualifiedVariations) {
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (variation.unitCombinationId !== this.selectedUnit && !(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNull)(this.selectedUnit)) {
    ...
    getInvalidSelectionByVariation: function getInvalidSelectionByVariation(variation) {
      ...
      var _loop = function _loop(_selectedAttributeId) {
        ...
        if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNull)(_this.selectedAttributes[_selectedAttributeId])) {
    ...
    correctSelection: function correctSelection(invalidSelection) {
      ...
      if (invalidSelection.newUnit) {
        if (this.lastContentCount > 1 && this.possibleUnitCombinationIds.length > 1 && !(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNull)(this.selectedUnit)) {
          messages.push(this.$translate("Ceres::Template.singleItemNotAvailable", {
    ...
    filterVariations: function filterVariations(attributes, unitId, strict, ignoreUnit) {
      ...
      if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(this.filteredVariationsCache[key])) {
        return this.filteredVariationsCache[key];
      }

      var uniqueValues = _toConsumableArray(new Set(Object.values(attributes)));

      var isEmptyOptionSelected = uniqueValues.length === 1 && (0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNull)(uniqueValues[0]);
      var filteredVariations = this.variations.filter(function (variation) {
        ...
        var _loop2 = function _loop2(attributeId) {
          ...
          if (variationAttribute && variationAttribute.attributeValueId !== attributes[attributeId] && (strict || !strict && !(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isNull)(attributes[attributeId]) && attributes[attributeId] !== -1)) {
            return {
              v: false
            };
          }
    ...
    setVariation: function setVariation(variationId) {
      ...
      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(variationId) && this.currentSelection) {
        variationId = this.currentSelection.variationId;
      }

      if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_24__.isDefined)(variationId)) {
    ...
    isTextCut: function isTextCut(content) {
      if (this.$refs.attributesContaner) {
        return (0,_helper_dom__WEBPACK_IMPORTED_MODULE_23__.textWidth)(content, "Custom-Font, Helvetica, Arial, sans-serif") > this.$refs.attributesContaner[0].clientWidth;
      }
...
//# sourceMappingURL=ceres-client-resources_js_src_app_components_item_VariationSelect_vue.js.map